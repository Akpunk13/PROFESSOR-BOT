...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/4528792c4f12b97272d4f.jpg")
...
IMDB = is_enabled((environ.get('IMDB', "Fasle")), False)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001481638340')).split()]
